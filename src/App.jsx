...
import { Col, Row, notification, Alert, Button, Input } from "antd";
...
import Preview from "./images/canceled.png";
...
function App({props}) {
  ...
  return (
    <Row className="App">
      ...
      <Col style={{position: "absolute", top: "100px"}} span={24}>
        <div >
      ...
      <button id="mint-btn"             
        ...
        <p id="mint-txt" style={{fontFamily: "monospace", paddingTop: "1px", paddingBottom: "1px", paddingLeft: "24px", paddingRight: "24px", margin: "0px"}}>Mint</p>
      </button>
        </div>    
      </Col>
    </Row>
